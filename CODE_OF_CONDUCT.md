...
Encrypt Storage and our community a harassment-free experience for everyone,
...
The project maintainer is responsible for clarifying and enforcing our standards
...
repository, issue tracker, pull requests, discussions, and any other
communication channel used by the project. It also applies when an individual is
officially representing the project in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to the project maintainer at **michelon.souza@hotmail.com**.
...
The project maintainer will follow these guidelines in determining the
